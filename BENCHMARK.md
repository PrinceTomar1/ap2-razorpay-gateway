...
**FALSE ACCEPTS: 0**  ·  **p50 0.270 ms · p95 0.298 ms · p99 0.365 ms**  ·  **4,182 verifications/sec**
...
Single-threaded throughput: **4,182 verifications/sec** (0.12s wall for 500).
...
here is 0.365 ms with no network at all. That is a difference of roughly
