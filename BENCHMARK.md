...
**FALSE ACCEPTS: 0**  ·  **p50 0.269 ms · p95 0.294 ms · p99 0.315 ms**  ·  **4,223 verifications/sec**
...
Single-threaded throughput: **4,223 verifications/sec** (0.12s wall for 500).
...
here is 0.315 ms with no network at all. That is a difference of roughly
