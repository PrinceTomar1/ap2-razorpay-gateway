...
**FALSE ACCEPTS: 0**  ·  **p50 0.325 ms · p95 0.381 ms · p99 0.641 ms**  ·  **3,385 verifications/sec**
...
Single-threaded throughput: **3,385 verifications/sec** (0.15s wall for 500).
...
here is 0.641 ms with no network at all. That is a difference of roughly
