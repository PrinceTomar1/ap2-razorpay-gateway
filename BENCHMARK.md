...
**FALSE ACCEPTS: 0**  ·  **p50 0.324 ms · p95 0.393 ms · p99 0.665 ms**  ·  **3,398 verifications/sec**
...
Single-threaded throughput: **3,398 verifications/sec** (0.15s wall for 500).
...
here is 0.665 ms with no network at all. That is a difference of roughly
