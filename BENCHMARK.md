...
**FALSE ACCEPTS: 0**  ·  **p50 0.268 ms · p95 0.290 ms · p99 0.307 ms**  ·  **4,272 verifications/sec**
...
Single-threaded throughput: **4,272 verifications/sec** (0.12s wall for 500).
...
here is 0.307 ms with no network at all. That is a difference of roughly
